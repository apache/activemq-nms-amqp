...
- **nms.maxMessageSize** Specifies maximum message size (body) to be accepted for send. If its bigger, exception may be thrown. The default value is -1 which means no limit.
